...
export class AddStockInModal extends Component {
    constructor(props) {
        super(props)
        this.state = {products: [], voucher: [], snackBarOpen: false, snackBarMsg: '', productQuantity: [], categories: [], selectValue: "", initialCategoryId: "", productId: "", quantity: "", productName: "", vnumber: ""}
    ...
    async handleSubmit(event) {
        ...
        formData.append('number', this.state.vnumber)

        try {
            const response = await stockApi.post('/voucher', formData);
            ...
            if(responsedData.length > 0) {
                var vId = this.getVoucherIdfromVoucherNumber(responsedData, this.state.vnumber)
                var voucherId = vId ? vId : ''
                this.setState({vnumber: ''})
                
            } else {
                alert('Voucher has no data')
            }
            
        } catch(error) {
            alert('Already exist Voucher with Same Number')
        }
            ...
            <Snackbar 
                ...
                />
                                ...
                                <div style={{display: 'flex'}} >
                                        <Form.Group controlId="VoucherNumber" className="col-md-2">
                                        ...
                                        <Form.Group controlId="VoucherFile" className="col-md-4">
                                        ...
                                        {
                                            this.state.productQuantity.length > 0 && this.state.vnumber? <button
                                                                                    ...
                                                                                    >
                                                                                    <span>
                                                                                        <span className="buttonText">ADD TO STOCK</span>
                                                                                    </span>
                                                                                    </button> :
                                                                                                <button
                                                                                                className="newFlyerButton btn mb-4"
