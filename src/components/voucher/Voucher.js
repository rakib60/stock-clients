...
export class Voucher extends Component {
    ...
    async deleteFile(cid) {  
        try {
                await stockApi.delete(`/voucher/${cid}`) 
            } catch(error) {
    ...
    render() {
        ...
        const {voucher, cId, cName} = this.state;
                    ...
                    voucher.map(voucher => {
                        return [
                          ...
                          <ButtonToolbar>
                            ...
                            onClick={()=> this.setState({editModalShow:true, cId:voucher.id, cName:voucher.name})}
                            >
                                Edit
                            </Button>
